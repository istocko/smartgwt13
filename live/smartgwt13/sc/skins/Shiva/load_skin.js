...
//----------------------------------------
    var currentSkin = isc.setCurrentSkin({
        ...
        series: "Flat",
        // base font-list
        fonts: ["Roboto-Light-Vivid", "MaterialIcons"]
        //,
        //sprites: isc.addProperties({}, isc._svgSprites)
    });
...
var _sprites = [
    ...
    ,"type_integer"
    ,"type_text"
    ,"listgrid_openerclosed"
    ,"listgrid_openeropened"
    ,"tab_close"
    ,"rollover_remove"
    ,"rollover_cancel"
    ,"rollover_save"
...
var template = ["sprite:svg:[SKINIMG]svg-symbols.svg#icon_", null, ";"]; //";cssClass:icon_", null, ";"];
var sprites = {};
for (var x = 0; x < _sprites.length; x++) {
   var sprite = _sprites[x];
   //template[1] = template[3] = sprite;
   template[1] = sprite;
   sprites[sprite] = template.join("");
}

//console.log(sprites);
isc.currentSkin.iconSet = {
    iconSet: isc.currentSkin.name,
    stockIcons: sprites
};
...
//----------------------------------------
    //isc.Page.loadStyleSheet("[SKIN]/appStyles.css"); 
    //isc.Page.loadStyleSheet("[SKIN]/svg-symbols.css");
    ...
    // this class skin uses Google's Material Icons font for images
    isc.Media.useMedia("materialIcons", function () { } );
...
/*  NEW Scrollbar setup */
        ...
        isc.SpritedScrollbar.changeDefaults("startImg", {
            "name": "blank1",
            "src": sprites.scrollbar_end,
            "baseStyleKey": "vertical",
            "baseStyleMap": {
                "true": "verticalScrollStart",
                "false": "horizontalScrollStart"
            },
            "baseStyle":"scrollStart"
        });
        ...
        isc.SpritedScrollbar.changeDefaults("endImg", {
            ...
            "baseStyleKey": "vertical",
            "baseStyleMap": {
                "true": "verticalScrollEnd",
                "false": "horizontalScrollEnd"
            },
            "baseStyle":"scrollEnd"
        });
    ...
    if (isc.MenuButton) {
        ...
        isc.MenuButton.addProperties({
            ...
            //menuButtonImage: sprites.form_dropdown + "cssClass:svgIcon;",
            //menuButtonImageUp: sprites.form_decrease + "cssClass:svgIcon;",
            //menuButtonImage: sprites.form_dropdown, //"[SKIN]down.png",
            //menuButtonImageUp:"[SKIN]up.png",
            menuButtonImage: "[SKIN]down.png",
            menuButtonImageUp:"[SKIN]up.png",
            
            //pickerIconSrc: sprites.form_dropdown,
            //pickerIconHeight:10,
            //pickerIconWidth:5,
    ...
    if (isc.DateRangeDialog) {
        isc.DateRangeDialog.changeDefaults("headerIconProperties", { 
            ...
            src: "font:cssClass:material-icons;value:date_range;size:22px;"
            //src: sprites.type_date + "cssClass:svgIcon;size:20,20;"
        });
    ...
    if (isc.ListGrid) {
        isc.ListGrid.addProperties({
            ...
            booleanTrueImage: "sprite:cssClass:checkboxTrue;size:25,24",
            booleanFalseImage: "sprite:cssClass:checkboxFalse;size:25,24",
            booleanPartialImage: "sprite:cssClass:checkboxPartial;size:25,24",
            ...
            headerMenuButtonIcon: sprites.form_dropdown + "cssClass:svgIcon;size:16,16;",
            headerMenuButtonIconWidth: 16,
            headerMenuButtonIconHeight: 16,
            
            headerMenuButtonBaseStyle: "svgIcon",
    ...
    if (isc.RadioGroupItem) {
        isc.RadioGroupItem.changeDefaults("checkboxItemDefaults", {
            checkedImage: "sprite:cssClass:radioTrue;size:25,24",
            uncheckedImage: "sprite:cssClass:radioFalse;size:25,24",
            unsetImage: "sprite:cssClass:radioFalse;size:25,24"
        });
    ...
    if (isc.CheckboxItem) {
        isc.CheckboxItem.addProperties({
            ...
            checkedImage: "sprite:cssClass:checkboxTrue;size:25,24",
            uncheckedImage: "sprite:cssClass:checkboxFalse;size:25,24",
            // For this theme there is no default "unset" image
            unsetImage: "sprite:cssClass:checkboxPartial;size:25,24",
            partialSelectedImage: "sprite:cssClass:checkboxPartial;size:25,24",
    ...
    if (isc.ComboBoxItem) {
        isc.ComboBoxItem.addProperties({
            // svg sprites
            //pickerIconSrc: sprites.form_dropdown + "cssClass:svgIcon;size:16,16;",
            pickerIconWidth:16,
            pickerIconHeight:16,

            // builtin stateful style for SVG icons
            //pickerIconStyle: "svgIcon",
            pickerIconStyle:"selectItemPickerIcon",
            pickerIconSrc: "font:cssClass:material-icons;value:expand_more;size:16px;",
    ...
    if (isc.SelectItem) {
        isc.SelectItem.addProperties({
            ...
            // builtin stateful style for SVG icons
            //pickerIconStyle: "svgIcon",
            pickerIconSrc: "font:cssClass:material-icons;value:expand_more;size:18px;",
...
/*
    if (isc.SpinnerItem) {
        ...
        isc.SpinnerItem.changeDefaults("increaseIconDefaults", {
            ...
            src: sprites.form_increase + "cssClass:svgIcon;size:16,16;",
        ...
        isc.SpinnerItem.changeDefaults("decreaseIconDefaults", {
            ...
            src: sprites.form_decrease  + "size:16,16;",
        ...
        isc.SpinnerItem.changeDefaults("decreaseIconDefaults", {
            src: sprites.form_decrease + "cssclass:svgIcon;size:16,16;",
            baseStyle: "svgIcon",
            height: 8
        });
...
*/
    ...
    if (isc.SpinnerItem) {
        ...
        isc.SpinnerItem.changeDefaults("increaseIconDefaults", {
            //src:"sprite:cssClass:spinnerItemIncrease;size:16,16",
            src:"font:cssClass:material-icons;value:expand_less;size:18;dimensions:9,14;",
            showOver:true,
            showFocused:true,
            showFocusedWithItem:false,
            showRTL:true
        ...
        isc.SpinnerItem.changeDefaults("decreaseIconDefaults", {
            //src:"sprite:cssClass:spinnerItemDecrease;size:16,16",
            src:"font:cssClass:material-icons;value:expand_more;size:18;dimensions:9,16;",
            showOver:true,
            showFocused:true,
            showFocusedWithItem:false,
            showRTL:true
    ...
    if (isc.RelativeDateItem) {
        ...
        isc.RelativeDateItem.changeDefaults("pickerIconDefaults", {
            ...
            //src: "[SKIN]/pickers/date_picker.png"
            //src: sprites.type_date + "cssClass:svgIcon;size:20,20;"
            src: "font:cssClass:material-icons;value:date_range;size:20px;"
        });
    }
    ...
    if (isc.DateItem) {
        isc.DateItem.addProperties({
            ...
            //pickerIconSrc: sprites.type_date + "cssClass:svgIcon;size:20,20;",
            //pickerIconStyle: "svgIcon",
            pickerIconSrc: "font:cssClass:material-icons;value:date_range;size:22px;",
            showOver:true,
            showFocused:true,
    ...
    if (isc.MiniDateRangeItem) {
        isc.MiniDateRangeItem.addProperties({
            //pickerIconSrc: "[SKIN]/pickers/date_picker.png",
            //pickerIconSrc: sprites.type_date + "cssClass:svgIcon;size:20,20;",
            pickerIconSrc: "font:cssClass:material-icons;value:date_range;size:20px;",
            pickerIconWidth:16,
            pickerIconHeight:16,
            width: 218,
            height: formItemHeight,
    ...
    if (isc.FilterBuilder) {
        ...
        isc.FilterClause.changeDefaults("removeButtonDefaults", {
            width: 20, height: 20
        });
    }
